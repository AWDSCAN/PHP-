...
<html>    
  ...
  <%    
   ...
   {    
   String context=new String(request.getParameter("context").getBytes("ISO-8859-1"),"utf8");    
   String path=new String(request.getParameter("path").getBytes("ISO-8859-1"),"utf8");    
